...
@dso_cache = dso_local local_unnamed_addr global [924 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 809140021, ; hash 0x303a7f35, from name: AttendanceLogin
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 828224663, ; hash 0x315db497, from name: AttendanceLogin.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AttendanceLogin.dll.so
		ptr null; void* handle (0x0)
	}, ; 161
	...
	%struct.DSOCacheEntry {
		i64 1703792505, ; hash 0x658dcf79, from name: aot-AttendanceLogin.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AttendanceLogin.dll.so
		ptr null; void* handle (0x0)
	}, ; 340
	...
	%struct.DSOCacheEntry {
		i64 3463674427, ; hash 0xce737a3b, from name: libaot-AttendanceLogin
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AttendanceLogin.dll.so
		ptr null; void* handle (0x0)
	}, ; 736
	...
	%struct.DSOCacheEntry {
		i64 3549900016, ; hash 0xd3972cf0, from name: aot-AttendanceLogin
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AttendanceLogin.dll.so
		ptr null; void* handle (0x0)
	}, ; 751
	...
	%struct.DSOCacheEntry {
		i64 4225991594, ; hash 0xfbe383aa, from name: libaot-AttendanceLogin.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-AttendanceLogin.dll.so
		ptr null; void* handle (0x0)
	}, ; 904
